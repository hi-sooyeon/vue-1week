<template>
  <div id="nav">
    ...
    <hr>
    <router-link to="/databindingattribue">Data Binding Attribue</router-link> |
    ...
    <router-link to="/renderingvifvshow">Rendering v-if / v-show</router-link> |
...
#nav {
  padding: 30px;
  border-bottom: 0.5em dashed #42b983;
}
